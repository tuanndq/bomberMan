...
public class Sprite {
	...
	public static Sprite player2_up = new Sprite(16, 0, 13, SpriteSheet.tiles, 12, 16);
	public static Sprite player2_down = new Sprite(16, 2, 13, SpriteSheet.tiles, 12, 16);
	public static Sprite player2_left = new Sprite(16, 3, 13, SpriteSheet.tiles, 10, 16);
	public static Sprite player2_right = new Sprite(16, 1, 13, SpriteSheet.tiles, 10, 16);

	public static Sprite player2_up_1 = new Sprite(16, 0, 14, SpriteSheet.tiles, 12, 16);
	public static Sprite player2_up_2 = new Sprite(16, 0, 15, SpriteSheet.tiles, 12, 15);

	public static Sprite player2_down_1 = new Sprite(16, 2, 14, SpriteSheet.tiles, 12, 15);
	public static Sprite player2_down_2 = new Sprite(16, 2, 15, SpriteSheet.tiles, 12, 16);

	public static Sprite player2_left_1 = new Sprite(16, 3, 14, SpriteSheet.tiles, 11, 16);
	public static Sprite player2_left_2 = new Sprite(16, 3, 15, SpriteSheet.tiles, 12 ,16);

	public static Sprite player2_right_1 = new Sprite(16, 1, 14, SpriteSheet.tiles, 11, 16);
	public static Sprite player2_right_2 = new Sprite(16, 1, 15, SpriteSheet.tiles, 12, 16);

	public static Sprite player2_dead1 = new Sprite(16, 4, 15, SpriteSheet.tiles, 14, 16);
